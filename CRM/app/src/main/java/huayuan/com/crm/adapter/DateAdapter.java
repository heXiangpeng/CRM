...
public class DateAdapter extends BaseAdapter {
	...
	public void setSeclection(int position) {
		this.currentday = dayNumber[position];
	}
	...
	public DateAdapter(Context context, Resources rs, int year_c, int month_c,
			int week_c, int week_num, int default_postion, boolean isStart,int day) {
		//this();
		this.sys_year = String.valueOf(year_c);
		this.sys_month = String.valueOf(month_c);
		this.sys_day = String.valueOf(day);
		month = Integer.parseInt(sys_month);
	...
	public void setdate(int year_c, int month_c,
						int week_c,int day){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView tvnl = (TextView) convertView.findViewById(R.id.tv_nl);
		//tvnl.setText(convertNlDay(Integer.parseInt(dayNumber[position])));

		tvCalendar.setText(dayNumber[position]);
		if (dayNumber[position].equals(currentDay)) {
